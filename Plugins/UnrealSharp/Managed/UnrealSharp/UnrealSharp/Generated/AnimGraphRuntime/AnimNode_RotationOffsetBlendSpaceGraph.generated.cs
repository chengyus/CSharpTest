...
[UStruct]
public partial struct AnimNode_RotationOffsetBlendSpaceGraph
{
    // StructProperty /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpaceGraph:BasePose
    static readonly int BasePose_Offset;
    public UnrealSharp.Engine.PoseLink BasePose;
    
    // IntProperty /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpaceGraph:LODThreshold
    static readonly int LODThreshold_Offset;
    public int LODThreshold;
    
    // FloatProperty /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpaceGraph:Alpha
    static readonly int Alpha_Offset;
    public float Alpha;
    
    // StructProperty /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpaceGraph:AlphaScaleBias
    static readonly int AlphaScaleBias_Offset;
    public UnrealSharp.Engine.InputScaleBias AlphaScaleBias;
    
    // StructProperty /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpaceGraph:AlphaBoolBlend
    static readonly int AlphaBoolBlend_Offset;
    public UnrealSharp.Engine.InputAlphaBoolBlend AlphaBoolBlend;
    
    // NameProperty /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpaceGraph:AlphaCurveName
    static readonly int AlphaCurveName_Offset;
    public Name AlphaCurveName;
    
    // StructProperty /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpaceGraph:AlphaScaleBiasClamp
    static readonly int AlphaScaleBiasClamp_Offset;
    public UnrealSharp.Engine.InputScaleBiasClamp AlphaScaleBiasClamp;
    
    // EnumProperty /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpaceGraph:AlphaInputType
    static readonly int AlphaInputType_Offset;
    public UnrealSharp.Engine.EAnimAlphaInputType AlphaInputType;
    
    // BoolProperty /Script/AnimGraphRuntime.AnimNode_RotationOffsetBlendSpaceGraph:bAlphaBoolEnabled
    static readonly int bAlphaBoolEnabled_Offset;
    public bool AlphaBoolEnabled;
    
    
    public static readonly int NativeDataSize;
    static AnimNode_RotationOffsetBlendSpaceGraph()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("AnimNode_RotationOffsetBlendSpaceGraph");
    ...
    public AnimNode_RotationOffsetBlendSpaceGraph(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class AnimNode_RotationOffsetBlendSpaceGraphMarshaler
{
    public static AnimNode_RotationOffsetBlendSpaceGraph FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new AnimNode_RotationOffsetBlendSpaceGraph(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, AnimNode_RotationOffsetBlendSpaceGraph obj)
    {
    ...
    {
        return AnimNode_RotationOffsetBlendSpaceGraph.NativeDataSize;
    }
}
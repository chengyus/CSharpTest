...
[UStruct]
public partial struct RigUnit_AimItem_Target
{
    // FloatProperty /Script/ControlRig.RigUnit_AimItem_Target:Weight
    static readonly int Weight_Offset;
    public float Weight;
    
    // StructProperty /Script/ControlRig.RigUnit_AimItem_Target:Axis
    static readonly int Axis_Offset;
    public System.DoubleNumerics.Vector3 Axis;
    
    // StructProperty /Script/ControlRig.RigUnit_AimItem_Target:Target
    static readonly int Target_Offset;
    public System.DoubleNumerics.Vector3 Target;
    
    // EnumProperty /Script/ControlRig.RigUnit_AimItem_Target:Kind
    static readonly int Kind_Offset;
    public UnrealSharp.ControlRig.EControlRigVectorKind Kind;
    
    // StructProperty /Script/ControlRig.RigUnit_AimItem_Target:Space
    static readonly int Space_Offset;
    public UnrealSharp.ControlRig.RigElementKey Space;
    
    
    public static readonly int NativeDataSize;
    static RigUnit_AimItem_Target()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("RigUnit_AimItem_Target");
    ...
    public RigUnit_AimItem_Target(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class RigUnit_AimItem_TargetMarshaler
{
    public static RigUnit_AimItem_Target FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new RigUnit_AimItem_Target(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, RigUnit_AimItem_Target obj)
    {
    ...
    {
        return RigUnit_AimItem_Target.NativeDataSize;
    }
}
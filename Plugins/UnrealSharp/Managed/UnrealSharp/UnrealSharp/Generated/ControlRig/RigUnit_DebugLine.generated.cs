...
[UStruct]
public partial struct RigUnit_DebugLine
{
    // StructProperty /Script/ControlRig.RigUnit_DebugLine:A
    static readonly int A_Offset;
    public System.DoubleNumerics.Vector3 A;
    
    // StructProperty /Script/ControlRig.RigUnit_DebugLine:B
    static readonly int B_Offset;
    public System.DoubleNumerics.Vector3 B;
    
    // StructProperty /Script/ControlRig.RigUnit_DebugLine:Color
    static readonly int Color_Offset;
    public UnrealSharp.CoreUObject.LinearColor Color;
    
    // FloatProperty /Script/ControlRig.RigUnit_DebugLine:Thickness
    static readonly int Thickness_Offset;
    public float Thickness;
    
    // NameProperty /Script/ControlRig.RigUnit_DebugLine:Space
    static readonly int Space_Offset;
    public Name Space;
    
    // StructProperty /Script/ControlRig.RigUnit_DebugLine:WorldOffset
    static readonly int WorldOffset_Offset;
    public UnrealSharp.Transform WorldOffset;
    
    // BoolProperty /Script/ControlRig.RigUnit_DebugLine:bEnabled
    static readonly int bEnabled_Offset;
    public bool Enabled;
    
    
    public static readonly int NativeDataSize;
    static RigUnit_DebugLine()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("RigUnit_DebugLine");
    ...
    public RigUnit_DebugLine(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class RigUnit_DebugLineMarshaler
{
    public static RigUnit_DebugLine FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new RigUnit_DebugLine(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, RigUnit_DebugLine obj)
    {
    ...
    {
        return RigUnit_DebugLine.NativeDataSize;
    }
}
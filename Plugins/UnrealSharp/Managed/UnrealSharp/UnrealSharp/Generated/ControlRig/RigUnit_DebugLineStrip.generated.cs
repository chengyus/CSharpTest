...
[UStruct]
public partial struct RigUnit_DebugLineStrip
{
    // StructProperty /Script/ControlRig.RigUnit_DebugLineStrip:Color
    static readonly int Color_Offset;
    public UnrealSharp.CoreUObject.LinearColor Color;
    
    // FloatProperty /Script/ControlRig.RigUnit_DebugLineStrip:Thickness
    static readonly int Thickness_Offset;
    public float Thickness;
    
    // NameProperty /Script/ControlRig.RigUnit_DebugLineStrip:Space
    static readonly int Space_Offset;
    public Name Space;
    
    // StructProperty /Script/ControlRig.RigUnit_DebugLineStrip:WorldOffset
    static readonly int WorldOffset_Offset;
    public UnrealSharp.Transform WorldOffset;
    
    // BoolProperty /Script/ControlRig.RigUnit_DebugLineStrip:bEnabled
    static readonly int bEnabled_Offset;
    public bool Enabled;
    
    
    public static readonly int NativeDataSize;
    static RigUnit_DebugLineStrip()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("RigUnit_DebugLineStrip");
    ...
    public RigUnit_DebugLineStrip(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class RigUnit_DebugLineStripMarshaler
{
    public static RigUnit_DebugLineStrip FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new RigUnit_DebugLineStrip(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, RigUnit_DebugLineStrip obj)
    {
    ...
    {
        return RigUnit_DebugLineStrip.NativeDataSize;
    }
}
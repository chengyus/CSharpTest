...
[UStruct]
public partial struct RigUnit_DebugTransform
{
    // StructProperty /Script/ControlRig.RigUnit_DebugTransform:Transform
    static readonly int Transform_Offset;
    public UnrealSharp.Transform Transform;
    
    // EnumProperty /Script/ControlRig.RigUnit_DebugTransform:Mode
    static readonly int Mode_Offset;
    public UnrealSharp.RigVM.ERigUnitDebugTransformMode Mode;
    
    // StructProperty /Script/ControlRig.RigUnit_DebugTransform:Color
    static readonly int Color_Offset;
    public UnrealSharp.CoreUObject.LinearColor Color;
    
    // FloatProperty /Script/ControlRig.RigUnit_DebugTransform:Thickness
    static readonly int Thickness_Offset;
    public float Thickness;
    
    // FloatProperty /Script/ControlRig.RigUnit_DebugTransform:Scale
    static readonly int Scale_Offset;
    public float Scale;
    
    // NameProperty /Script/ControlRig.RigUnit_DebugTransform:Space
    static readonly int Space_Offset;
    public Name Space;
    
    // StructProperty /Script/ControlRig.RigUnit_DebugTransform:WorldOffset
    static readonly int WorldOffset_Offset;
    public UnrealSharp.Transform WorldOffset;
    
    // BoolProperty /Script/ControlRig.RigUnit_DebugTransform:bEnabled
    static readonly int bEnabled_Offset;
    public bool Enabled;
    
    
    public static readonly int NativeDataSize;
    static RigUnit_DebugTransform()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("RigUnit_DebugTransform");
    ...
    public RigUnit_DebugTransform(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class RigUnit_DebugTransformMarshaler
{
    public static RigUnit_DebugTransform FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new RigUnit_DebugTransform(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, RigUnit_DebugTransform obj)
    {
    ...
    {
        return RigUnit_DebugTransform.NativeDataSize;
    }
}
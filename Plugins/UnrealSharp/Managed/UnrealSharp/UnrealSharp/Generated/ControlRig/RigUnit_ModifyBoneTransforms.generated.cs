...
[UStruct]
public partial struct RigUnit_ModifyBoneTransforms
{
    // FloatProperty /Script/ControlRig.RigUnit_ModifyBoneTransforms:Weight
    static readonly int Weight_Offset;
    public float Weight;
    
    // FloatProperty /Script/ControlRig.RigUnit_ModifyBoneTransforms:WeightMinimum
    static readonly int WeightMinimum_Offset;
    public float WeightMinimum;
    
    // FloatProperty /Script/ControlRig.RigUnit_ModifyBoneTransforms:WeightMaximum
    static readonly int WeightMaximum_Offset;
    public float WeightMaximum;
    
    // EnumProperty /Script/ControlRig.RigUnit_ModifyBoneTransforms:Mode
    static readonly int Mode_Offset;
    public UnrealSharp.ControlRig.EControlRigModifyBoneMode Mode;
    
    
    public static readonly int NativeDataSize;
    static RigUnit_ModifyBoneTransforms()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("RigUnit_ModifyBoneTransforms");
    ...
    public RigUnit_ModifyBoneTransforms(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class RigUnit_ModifyBoneTransformsMarshaler
{
    public static RigUnit_ModifyBoneTransforms FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new RigUnit_ModifyBoneTransforms(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, RigUnit_ModifyBoneTransforms obj)
    {
    ...
    {
        return RigUnit_ModifyBoneTransforms.NativeDataSize;
    }
}
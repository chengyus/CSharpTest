...
[UStruct]
public partial struct RigUnit_ControlRigSplineFromTransforms
{
    // EnumProperty /Script/ControlRigSpline.RigUnit_ControlRigSplineFromTransforms:SplineMode
    static readonly int SplineMode_Offset;
    public UnrealSharp.ControlRigSpline.ESplineType SplineMode;
    
    // BoolProperty /Script/ControlRigSpline.RigUnit_ControlRigSplineFromTransforms:bClosed
    static readonly int bClosed_Offset;
    public bool Closed;
    
    // IntProperty /Script/ControlRigSpline.RigUnit_ControlRigSplineFromTransforms:SamplesPerSegment
    static readonly int SamplesPerSegment_Offset;
    public int SamplesPerSegment;
    
    // FloatProperty /Script/ControlRigSpline.RigUnit_ControlRigSplineFromTransforms:Compression
    static readonly int Compression_Offset;
    public float Compression;
    
    // FloatProperty /Script/ControlRigSpline.RigUnit_ControlRigSplineFromTransforms:Stretch
    static readonly int Stretch_Offset;
    public float Stretch;
    
    // StructProperty /Script/ControlRigSpline.RigUnit_ControlRigSplineFromTransforms:Spline
    static readonly int Spline_Offset;
    public UnrealSharp.ControlRigSpline.ControlRigSpline Spline;
    
    
    public static readonly int NativeDataSize;
    static RigUnit_ControlRigSplineFromTransforms()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("RigUnit_ControlRigSplineFromTransforms");
    ...
    public RigUnit_ControlRigSplineFromTransforms(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class RigUnit_ControlRigSplineFromTransformsMarshaler
{
    public static RigUnit_ControlRigSplineFromTransforms FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new RigUnit_ControlRigSplineFromTransforms(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, RigUnit_ControlRigSplineFromTransforms obj)
    {
    ...
    {
        return RigUnit_ControlRigSplineFromTransforms.NativeDataSize;
    }
}
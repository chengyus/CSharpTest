...
[UClass]
public partial class TextureRenderTarget2DArray : UnrealSharp.Engine.TextureRenderTarget
{
    
    static TextureRenderTarget2DArray()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("TextureRenderTarget2DArray");
        ...
        Slices_Offset = FPropertyExporter.CallGetPropertyOffsetFromName(NativeClassPtr, "Slices");
    ...
    protected TextureRenderTarget2DArray(IntPtr nativeObject) : base(nativeObject)
    {
    }
    // IntProperty /Script/Engine.TextureRenderTarget2DArray:SizeX
    ...
    // IntProperty /Script/Engine.TextureRenderTarget2DArray:SizeY
    ...
    // IntProperty /Script/Engine.TextureRenderTarget2DArray:Slices
    static readonly int Slices_Offset;
    ...
    public int Slices
    {
        ...
        {
            CheckObjectForValidity();
            return BlittableMarshaller<int>.FromNative(IntPtr.Add(NativeObject, Slices_Offset), 0, this);
        }
        set
        {
            CheckObjectForValidity();
            BlittableMarshaller<int>.ToNative(IntPtr.Add(NativeObject, Slices_Offset), 0, this, value);
        }
    }
    
    // BoolProperty /Script/Engine.TextureRenderTarget2DArray:bHDR

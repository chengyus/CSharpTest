...
[UClass]
public partial class InterchangeBaseLightFactoryNode : UnrealSharp.InterchangeFactoryNodes.InterchangeActorFactoryNode
{
    
    static InterchangeBaseLightFactoryNode()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("InterchangeBaseLightFactoryNode");
        ...
        SetCustomUseTemperature_bAddApplyDelegate_Offset = FPropertyExporter.CallGetPropertyOffsetFromName(SetCustomUseTemperature_NativeFunction, "bAddApplyDelegate");
        ...
        SetCustomTemperature_bAddApplyDelegate_Offset = FPropertyExporter.CallGetPropertyOffsetFromName(SetCustomTemperature_NativeFunction, "bAddApplyDelegate");
        ...
        SetCustomLightColor_bAddApplyDelegate_Offset = FPropertyExporter.CallGetPropertyOffsetFromName(SetCustomLightColor_NativeFunction, "bAddApplyDelegate");
        ...
        SetCustomIntensity_bAddApplyDelegate_Offset = FPropertyExporter.CallGetPropertyOffsetFromName(SetCustomIntensity_NativeFunction, "bAddApplyDelegate");
    ...
    protected InterchangeBaseLightFactoryNode(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    static readonly int SetCustomUseTemperature_bAddApplyDelegate_Offset;
    static readonly int SetCustomUseTemperature_ReturnValue_Offset;
    
    public bool SetCustomUseTemperature(bool attributeValue, bool bAddApplyDelegate = true)
    {
        unsafe
        {
            ...
            BoolMarshaller.ToNative(IntPtr.Add(ParamsBuffer, SetCustomUseTemperature_bAddApplyDelegate_Offset), 0, null, bAddApplyDelegate);
    ...
    static readonly int SetCustomTemperature_bAddApplyDelegate_Offset;
    static readonly int SetCustomTemperature_ReturnValue_Offset;
    
    public bool SetCustomTemperature(float attributeValue, bool bAddApplyDelegate = true)
    {
        unsafe
        {
            ...
            BoolMarshaller.ToNative(IntPtr.Add(ParamsBuffer, SetCustomTemperature_bAddApplyDelegate_Offset), 0, null, bAddApplyDelegate);
    ...
    static readonly int SetCustomLightColor_bAddApplyDelegate_Offset;
    static readonly int SetCustomLightColor_ReturnValue_Offset;
    
    public bool SetCustomLightColor(UnrealSharp.CoreUObject.Color attributeValue, bool bAddApplyDelegate = true)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[SetCustomLightColor_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            BlittableMarshaller<UnrealSharp.CoreUObject.Color>.ToNative(IntPtr.Add(ParamsBuffer, SetCustomLightColor_AttributeValue_Offset), 0, null, attributeValue);
            BoolMarshaller.ToNative(IntPtr.Add(ParamsBuffer, SetCustomLightColor_bAddApplyDelegate_Offset), 0, null, bAddApplyDelegate);
    ...
    static readonly int SetCustomIntensity_bAddApplyDelegate_Offset;
    static readonly int SetCustomIntensity_ReturnValue_Offset;
    
    public bool SetCustomIntensity(float attributeValue, bool bAddApplyDelegate = true)
    {
        unsafe
        {
            ...
            BoolMarshaller.ToNative(IntPtr.Add(ParamsBuffer, SetCustomIntensity_bAddApplyDelegate_Offset), 0, null, bAddApplyDelegate);
    ...
    public bool GetCustomLightColor(out UnrealSharp.CoreUObject.Color attributeValue)
    {
        unsafe
        {
            ...
            attributeValue = BlittableMarshaller<UnrealSharp.CoreUObject.Color>.FromNative(IntPtr.Add(ParamsBuffer, GetCustomLightColor_AttributeValue_Offset), 0, null);
            bool returnValue;

...
[UClass]
public partial class InterchangeLightFactoryNode : UnrealSharp.InterchangeFactoryNodes.InterchangeBaseLightFactoryNode
{
    
    static InterchangeLightFactoryNode()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("InterchangeLightFactoryNode");
        ...
        SetCustomIntensityUnits_bAddApplyDelegate_Offset = FPropertyExporter.CallGetPropertyOffsetFromName(SetCustomIntensityUnits_NativeFunction, "bAddApplyDelegate");
        ...
        SetCustomAttenuationRadius_bAddApplyDelegate_Offset = FPropertyExporter.CallGetPropertyOffsetFromName(SetCustomAttenuationRadius_NativeFunction, "bAddApplyDelegate");
    ...
    protected InterchangeLightFactoryNode(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    static readonly int SetCustomIntensityUnits_bAddApplyDelegate_Offset;
    static readonly int SetCustomIntensityUnits_ReturnValue_Offset;
    
    public bool SetCustomIntensityUnits(UnrealSharp.Engine.ELightUnits attributeValue, bool bAddApplyDelegate = true)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[SetCustomIntensityUnits_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            BlittableMarshaller<UnrealSharp.Engine.ELightUnits>.ToNative(IntPtr.Add(ParamsBuffer, SetCustomIntensityUnits_AttributeValue_Offset), 0, null, attributeValue);
            BoolMarshaller.ToNative(IntPtr.Add(ParamsBuffer, SetCustomIntensityUnits_bAddApplyDelegate_Offset), 0, null, bAddApplyDelegate);
    ...
    static readonly int SetCustomAttenuationRadius_bAddApplyDelegate_Offset;
    static readonly int SetCustomAttenuationRadius_ReturnValue_Offset;
    
    public bool SetCustomAttenuationRadius(float attributeValue, bool bAddApplyDelegate = true)
    {
        unsafe
        {
            ...
            BoolMarshaller.ToNative(IntPtr.Add(ParamsBuffer, SetCustomAttenuationRadius_bAddApplyDelegate_Offset), 0, null, bAddApplyDelegate);
    ...
    public bool GetCustomIntensityUnits(out UnrealSharp.Engine.ELightUnits attributeValue)
    {
        unsafe
        {
            ...
            attributeValue = BlittableMarshaller<UnrealSharp.Engine.ELightUnits>.FromNative(IntPtr.Add(ParamsBuffer, GetCustomIntensityUnits_AttributeValue_Offset), 0, null);
            bool returnValue;

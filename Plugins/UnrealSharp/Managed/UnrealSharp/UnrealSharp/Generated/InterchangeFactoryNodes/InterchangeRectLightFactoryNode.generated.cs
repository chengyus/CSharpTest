...
[UClass]
public partial class InterchangeRectLightFactoryNode : UnrealSharp.InterchangeFactoryNodes.InterchangeLightFactoryNode
{
    
    static InterchangeRectLightFactoryNode()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("InterchangeRectLightFactoryNode");
        ...
        SetCustomSourceWidth_bAddApplyDelegate_Offset = FPropertyExporter.CallGetPropertyOffsetFromName(SetCustomSourceWidth_NativeFunction, "bAddApplyDelegate");
        ...
        SetCustomSourceHeight_bAddApplyDelegate_Offset = FPropertyExporter.CallGetPropertyOffsetFromName(SetCustomSourceHeight_NativeFunction, "bAddApplyDelegate");
    ...
    protected InterchangeRectLightFactoryNode(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    static readonly int SetCustomSourceWidth_bAddApplyDelegate_Offset;
    static readonly int SetCustomSourceWidth_ReturnValue_Offset;
    
    public bool SetCustomSourceWidth(float attributeValue, bool bAddApplyDelegate = true)
    {
        unsafe
        {
            ...
            BoolMarshaller.ToNative(IntPtr.Add(ParamsBuffer, SetCustomSourceWidth_bAddApplyDelegate_Offset), 0, null, bAddApplyDelegate);
    ...
    static readonly int SetCustomSourceHeight_bAddApplyDelegate_Offset;
    static readonly int SetCustomSourceHeight_ReturnValue_Offset;
    
    public bool SetCustomSourceHeight(float attributeValue, bool bAddApplyDelegate = true)
    {
        unsafe
        {
            ...
            BoolMarshaller.ToNative(IntPtr.Add(ParamsBuffer, SetCustomSourceHeight_bAddApplyDelegate_Offset), 0, null, bAddApplyDelegate);

...
[UClass]
public partial class InterchangeStandardCameraNode : UnrealSharp.InterchangeCore.InterchangeBaseNode
{
    
    static InterchangeStandardCameraNode()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("InterchangeStandardCameraNode");
    ...
    protected InterchangeStandardCameraNode(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public bool SetCustomWidth(float attributeValue)
    {
        unsafe
        {
    ...
    public bool SetCustomProjectionMode(UnrealSharp.InterchangeNodes.EInterchangeCameraProjectionType attributeValue)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[SetCustomProjectionMode_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            BlittableMarshaller<UnrealSharp.InterchangeNodes.EInterchangeCameraProjectionType>.ToNative(IntPtr.Add(ParamsBuffer, SetCustomProjectionMode_AttributeValue_Offset), 0, null, attributeValue);
    ...
    public bool SetCustomNearClipPlane(float attributeValue)
    {
        unsafe
        {
    ...
    public bool SetCustomFieldOfView(float attributeValue)
    {
        unsafe
        {
    ...
    public bool SetCustomFarClipPlane(float attributeValue)
    {
        unsafe
        {
    ...
    public bool SetCustomAspectRatio(float attributeValue)
    {
        unsafe
        {
    ...
    public bool GetCustomProjectionMode(out UnrealSharp.InterchangeNodes.EInterchangeCameraProjectionType attributeValue)
    {
        unsafe
        {
            ...
            attributeValue = BlittableMarshaller<UnrealSharp.InterchangeNodes.EInterchangeCameraProjectionType>.FromNative(IntPtr.Add(ParamsBuffer, GetCustomProjectionMode_AttributeValue_Offset), 0, null);
            bool returnValue;

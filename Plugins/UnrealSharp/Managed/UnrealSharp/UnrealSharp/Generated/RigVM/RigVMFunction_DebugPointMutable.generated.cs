...
[UStruct]
public partial struct RigVMFunction_DebugPointMutable
{
    // StructProperty /Script/RigVM.RigVMFunction_DebugPointMutable:Vector
    static readonly int Vector_Offset;
    public System.DoubleNumerics.Vector3 Vector;
    
    // EnumProperty /Script/RigVM.RigVMFunction_DebugPointMutable:Mode
    static readonly int Mode_Offset;
    public UnrealSharp.RigVM.ERigUnitDebugPointMode Mode;
    
    // StructProperty /Script/RigVM.RigVMFunction_DebugPointMutable:Color
    static readonly int Color_Offset;
    public UnrealSharp.CoreUObject.LinearColor Color;
    
    // FloatProperty /Script/RigVM.RigVMFunction_DebugPointMutable:Scale
    static readonly int Scale_Offset;
    public float Scale;
    
    // FloatProperty /Script/RigVM.RigVMFunction_DebugPointMutable:Thickness
    static readonly int Thickness_Offset;
    public float Thickness;
    
    // NameProperty /Script/RigVM.RigVMFunction_DebugPointMutable:Space
    static readonly int Space_Offset;
    public Name Space;
    
    // StructProperty /Script/RigVM.RigVMFunction_DebugPointMutable:WorldOffset
    static readonly int WorldOffset_Offset;
    public UnrealSharp.Transform WorldOffset;
    
    // BoolProperty /Script/RigVM.RigVMFunction_DebugPointMutable:bEnabled
    static readonly int bEnabled_Offset;
    public bool Enabled;
    
    
    public static readonly int NativeDataSize;
    static RigVMFunction_DebugPointMutable()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("RigVMFunction_DebugPointMutable");
    ...
    public RigVMFunction_DebugPointMutable(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class RigVMFunction_DebugPointMutableMarshaler
{
    public static RigVMFunction_DebugPointMutable FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new RigVMFunction_DebugPointMutable(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, RigVMFunction_DebugPointMutable obj)
    {
    ...
    {
        return RigVMFunction_DebugPointMutable.NativeDataSize;
    }
}
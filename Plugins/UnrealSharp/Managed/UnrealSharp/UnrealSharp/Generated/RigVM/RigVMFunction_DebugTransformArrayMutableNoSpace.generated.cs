...
[UStruct]
public partial struct RigVMFunction_DebugTransformArrayMutableNoSpace
{
    // EnumProperty /Script/RigVM.RigVMFunction_DebugTransformArrayMutableNoSpace:Mode
    static readonly int Mode_Offset;
    public UnrealSharp.RigVM.ERigUnitDebugTransformMode Mode;
    
    // StructProperty /Script/RigVM.RigVMFunction_DebugTransformArrayMutableNoSpace:Color
    static readonly int Color_Offset;
    public UnrealSharp.CoreUObject.LinearColor Color;
    
    // FloatProperty /Script/RigVM.RigVMFunction_DebugTransformArrayMutableNoSpace:Thickness
    static readonly int Thickness_Offset;
    public float Thickness;
    
    // FloatProperty /Script/RigVM.RigVMFunction_DebugTransformArrayMutableNoSpace:Scale
    static readonly int Scale_Offset;
    public float Scale;
    
    // StructProperty /Script/RigVM.RigVMFunction_DebugTransformArrayMutableNoSpace:WorldOffset
    static readonly int WorldOffset_Offset;
    public UnrealSharp.Transform WorldOffset;
    
    // BoolProperty /Script/RigVM.RigVMFunction_DebugTransformArrayMutableNoSpace:bEnabled
    static readonly int bEnabled_Offset;
    public bool Enabled;
    
    
    public static readonly int NativeDataSize;
    static RigVMFunction_DebugTransformArrayMutableNoSpace()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("RigVMFunction_DebugTransformArrayMutableNoSpace");
    ...
    public RigVMFunction_DebugTransformArrayMutableNoSpace(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class RigVMFunction_DebugTransformArrayMutableNoSpaceMarshaler
{
    public static RigVMFunction_DebugTransformArrayMutableNoSpace FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new RigVMFunction_DebugTransformArrayMutableNoSpace(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, RigVMFunction_DebugTransformArrayMutableNoSpace obj)
    {
    ...
    {
        return RigVMFunction_DebugTransformArrayMutableNoSpace.NativeDataSize;
    }
}
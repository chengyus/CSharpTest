...
[UClass]
public partial class MovieSceneDoubleVectorTrackExtensions : UnrealSharp.Engine.BlueprintFunctionLibrary
{
    
    static readonly IntPtr NativeClassPtr;
    static MovieSceneDoubleVectorTrackExtensions()
    {
        NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneDoubleVectorTrackExtensions");
    ...
    protected MovieSceneDoubleVectorTrackExtensions(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public static void SetNumChannelsUsed(UnrealSharp.MovieSceneTracks.MovieSceneDoubleVectorTrack track, int inNumChannelsUsed)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[SetNumChannelsUsed_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            ObjectMarshaller<UnrealSharp.MovieSceneTracks.MovieSceneDoubleVectorTrack>.ToNative(IntPtr.Add(ParamsBuffer, SetNumChannelsUsed_Track_Offset), 0, null, track);
    ...
    public static int GetNumChannelsUsed(UnrealSharp.MovieSceneTracks.MovieSceneDoubleVectorTrack track)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[GetNumChannelsUsed_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            ObjectMarshaller<UnrealSharp.MovieSceneTracks.MovieSceneDoubleVectorTrack>.ToNative(IntPtr.Add(ParamsBuffer, GetNumChannelsUsed_Track_Offset), 0, null, track);

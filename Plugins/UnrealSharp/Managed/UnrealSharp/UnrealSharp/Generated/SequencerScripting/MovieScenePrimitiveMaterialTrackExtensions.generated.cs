...
[UClass]
public partial class MovieScenePrimitiveMaterialTrackExtensions : UnrealSharp.Engine.BlueprintFunctionLibrary
{
    
    static readonly IntPtr NativeClassPtr;
    static MovieScenePrimitiveMaterialTrackExtensions()
    {
        NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieScenePrimitiveMaterialTrackExtensions");
    ...
    protected MovieScenePrimitiveMaterialTrackExtensions(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public static void SetMaterialIndex(UnrealSharp.MovieSceneTracks.MovieScenePrimitiveMaterialTrack track, int materialIndex)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[SetMaterialIndex_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            ObjectMarshaller<UnrealSharp.MovieSceneTracks.MovieScenePrimitiveMaterialTrack>.ToNative(IntPtr.Add(ParamsBuffer, SetMaterialIndex_Track_Offset), 0, null, track);
    ...
    public static int GetMaterialIndex(UnrealSharp.MovieSceneTracks.MovieScenePrimitiveMaterialTrack track)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[GetMaterialIndex_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            ObjectMarshaller<UnrealSharp.MovieSceneTracks.MovieScenePrimitiveMaterialTrack>.ToNative(IntPtr.Add(ParamsBuffer, GetMaterialIndex_Track_Offset), 0, null, track);

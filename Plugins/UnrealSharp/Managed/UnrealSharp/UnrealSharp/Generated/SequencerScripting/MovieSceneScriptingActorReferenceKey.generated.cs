...
[UClass]
public partial class MovieSceneScriptingActorReferenceKey : UnrealSharp.SequencerScripting.MovieSceneScriptingKey
{
    
    static MovieSceneScriptingActorReferenceKey()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingActorReferenceKey");
    ...
    protected MovieSceneScriptingActorReferenceKey(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetValue(UnrealSharp.MovieScene.MovieSceneObjectBindingID inNewValue)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[SetValue_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            UnrealSharp.MovieScene.MovieSceneObjectBindingIDMarshaler.ToNative(IntPtr.Add(ParamsBuffer, SetValue_InNewValue_Offset), 0, null, inNewValue);
    ...
    public UnrealSharp.MovieScene.MovieSceneObjectBindingID GetValue()
    {
        unsafe
        {
            ...
            returnValue = UnrealSharp.MovieScene.MovieSceneObjectBindingIDMarshaler.FromNative(IntPtr.Add(ParamsBuffer, GetValue_ReturnValue_Offset), 0, null);

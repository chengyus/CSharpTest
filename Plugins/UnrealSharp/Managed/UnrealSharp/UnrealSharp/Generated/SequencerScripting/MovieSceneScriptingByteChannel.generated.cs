...
[UClass]
public partial class MovieSceneScriptingByteChannel : UnrealSharp.SequencerScripting.MovieSceneScriptingChannel
{
    
    static MovieSceneScriptingByteChannel()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingByteChannel");
    ...
    protected MovieSceneScriptingByteChannel(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetDefault(byte inDefaultValue)
    {
        unsafe
        {
            ...
            BlittableMarshaller<byte>.ToNative(IntPtr.Add(ParamsBuffer, SetDefault_InDefaultValue_Offset), 0, null, inDefaultValue);
    ...
    public byte GetDefault()
    {
        unsafe
        {
            ...
            byte returnValue;
            returnValue = BlittableMarshaller<byte>.FromNative(IntPtr.Add(ParamsBuffer, GetDefault_ReturnValue_Offset), 0, null);
    ...
    public UnrealSharp.SequencerScripting.MovieSceneScriptingByteKey AddKey(UnrealSharp.CoreUObject.FrameNumber inTime, byte newValue, float subFrame = 0.000000f, UnrealSharp.SequencerScripting.ESequenceTimeUnit timeUnit = UnrealSharp.SequencerScripting.ESequenceTimeUnit.DisplayRate, UnrealSharp.MovieScene.EMovieSceneKeyInterpolation inInterpolation = UnrealSharp.MovieScene.EMovieSceneKeyInterpolation.Auto)
    {
        unsafe
        {
            ...
            BlittableMarshaller<byte>.ToNative(IntPtr.Add(ParamsBuffer, AddKey_NewValue_Offset), 0, null, newValue);
            ...
            UnrealSharp.SequencerScripting.MovieSceneScriptingByteKey returnValue;
            returnValue = ObjectMarshaller<UnrealSharp.SequencerScripting.MovieSceneScriptingByteKey>.FromNative(IntPtr.Add(ParamsBuffer, AddKey_ReturnValue_Offset), 0, null);

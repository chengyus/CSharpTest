...
[UClass]
public partial class MovieSceneScriptingByteKey : UnrealSharp.SequencerScripting.MovieSceneScriptingKey
{
    
    static MovieSceneScriptingByteKey()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingByteKey");
    ...
    protected MovieSceneScriptingByteKey(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetValue(byte inNewValue)
    {
        unsafe
        {
            ...
            BlittableMarshaller<byte>.ToNative(IntPtr.Add(ParamsBuffer, SetValue_InNewValue_Offset), 0, null, inNewValue);
    ...
    public byte GetValue()
    {
        unsafe
        {
            ...
            byte returnValue;
            returnValue = BlittableMarshaller<byte>.FromNative(IntPtr.Add(ParamsBuffer, GetValue_ReturnValue_Offset), 0, null);

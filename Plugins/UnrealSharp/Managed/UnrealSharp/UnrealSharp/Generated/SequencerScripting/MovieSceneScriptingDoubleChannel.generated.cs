...
[UClass]
public partial class MovieSceneScriptingDoubleChannel : UnrealSharp.SequencerScripting.MovieSceneScriptingChannel
{
    
    static MovieSceneScriptingDoubleChannel()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingDoubleChannel");
    ...
    protected MovieSceneScriptingDoubleChannel(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetDefault(double inDefaultValue)
    {
        unsafe
        {
            ...
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            BlittableMarshaller<double>.ToNative(IntPtr.Add(ParamsBuffer, SetDefault_InDefaultValue_Offset), 0, null, inDefaultValue);
    ...
    public double GetDefault()
    {
        unsafe
        {
            ...
            double returnValue;
            returnValue = BlittableMarshaller<double>.FromNative(IntPtr.Add(ParamsBuffer, GetDefault_ReturnValue_Offset), 0, null);
    ...
    public System.Collections.Generic.IList<double> EvaluateKeys(UnrealSharp.SequencerScripting.SequencerScriptingRange range, UnrealSharp.CoreUObject.FrameRate frameRate)
    {
        unsafe
        {
            ...
            System.Collections.Generic.IList<double> returnValue;
            IntPtr ReturnValue_NativeBuffer = IntPtr.Add(ParamsBuffer, EvaluateKeys_ReturnValue_Offset);
            UnrealArrayCopyMarshaler<double> ReturnValue_Marshaler = new UnrealArrayCopyMarshaler<double> (1, BlittableMarshaller<double>.ToNative, BlittableMarshaller<double>.FromNative, EvaluateKeys_ReturnValue_ElementSize);
            returnValue = ReturnValue_Marshaler.FromNative(ReturnValue_NativeBuffer, 0, null);
            UnrealArrayCopyMarshaler<double>.DestructInstance(ReturnValue_NativeBuffer, 0);
    ...
    public UnrealSharp.SequencerScripting.MovieSceneScriptingDoubleKey AddKey(UnrealSharp.CoreUObject.FrameNumber inTime, double newValue, float subFrame = 0.000000f, UnrealSharp.SequencerScripting.ESequenceTimeUnit timeUnit = UnrealSharp.SequencerScripting.ESequenceTimeUnit.DisplayRate, UnrealSharp.MovieScene.EMovieSceneKeyInterpolation inInterpolation = UnrealSharp.MovieScene.EMovieSceneKeyInterpolation.Auto)
    {
        unsafe
        {
            ...
            BlittableMarshaller<double>.ToNative(IntPtr.Add(ParamsBuffer, AddKey_NewValue_Offset), 0, null, newValue);
            ...
            UnrealSharp.SequencerScripting.MovieSceneScriptingDoubleKey returnValue;
            returnValue = ObjectMarshaller<UnrealSharp.SequencerScripting.MovieSceneScriptingDoubleKey>.FromNative(IntPtr.Add(ParamsBuffer, AddKey_ReturnValue_Offset), 0, null);

...
[UClass]
public partial class MovieSceneScriptingEventKey : UnrealSharp.SequencerScripting.MovieSceneScriptingKey
{
    
    static MovieSceneScriptingEventKey()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingEventKey");
    ...
    protected MovieSceneScriptingEventKey(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetValue(UnrealSharp.MovieSceneTracks.MovieSceneEvent inNewValue)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[SetValue_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            UnrealSharp.MovieSceneTracks.MovieSceneEventMarshaler.ToNative(IntPtr.Add(ParamsBuffer, SetValue_InNewValue_Offset), 0, null, inNewValue);
    ...
    public UnrealSharp.MovieSceneTracks.MovieSceneEvent GetValue()
    {
        unsafe
        {
            ...
            UnrealSharp.MovieSceneTracks.MovieSceneEvent returnValue;
            returnValue = UnrealSharp.MovieSceneTracks.MovieSceneEventMarshaler.FromNative(IntPtr.Add(ParamsBuffer, GetValue_ReturnValue_Offset), 0, null);

...
[UClass]
abstract public partial class MovieSceneScriptingFloatKey : UnrealSharp.SequencerScripting.MovieSceneScriptingKey
{
    
    static MovieSceneScriptingFloatKey()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingFloatKey");
    ...
    protected MovieSceneScriptingFloatKey(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetValue(float inNewValue)
    {
        unsafe
        {
            ...
            BlittableMarshaller<float>.ToNative(IntPtr.Add(ParamsBuffer, SetValue_InNewValue_Offset), 0, null, inNewValue);

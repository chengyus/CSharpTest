...
[UClass]
public partial class MovieSceneScriptingIntegerChannel : UnrealSharp.SequencerScripting.MovieSceneScriptingChannel
{
    
    static MovieSceneScriptingIntegerChannel()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingIntegerChannel");
    ...
    protected MovieSceneScriptingIntegerChannel(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetDefault(int inDefaultValue)
    {
        unsafe
        {
            ...
            BlittableMarshaller<int>.ToNative(IntPtr.Add(ParamsBuffer, SetDefault_InDefaultValue_Offset), 0, null, inDefaultValue);
    ...
    public int GetDefault()
    {
        unsafe
        {
            ...
            int returnValue;
            returnValue = BlittableMarshaller<int>.FromNative(IntPtr.Add(ParamsBuffer, GetDefault_ReturnValue_Offset), 0, null);
    ...
    public UnrealSharp.SequencerScripting.MovieSceneScriptingIntegerKey AddKey(UnrealSharp.CoreUObject.FrameNumber inTime, int newValue, float subFrame = 0.000000f, UnrealSharp.SequencerScripting.ESequenceTimeUnit timeUnit = UnrealSharp.SequencerScripting.ESequenceTimeUnit.DisplayRate)
    {
        unsafe
        {
            ...
            BlittableMarshaller<int>.ToNative(IntPtr.Add(ParamsBuffer, AddKey_NewValue_Offset), 0, null, newValue);
            ...
            UnrealSharp.SequencerScripting.MovieSceneScriptingIntegerKey returnValue;
            returnValue = ObjectMarshaller<UnrealSharp.SequencerScripting.MovieSceneScriptingIntegerKey>.FromNative(IntPtr.Add(ParamsBuffer, AddKey_ReturnValue_Offset), 0, null);

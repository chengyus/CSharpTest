...
[UClass]
public partial class MovieSceneScriptingObjectPathKey : UnrealSharp.SequencerScripting.MovieSceneScriptingKey
{
    
    static MovieSceneScriptingObjectPathKey()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingObjectPathKey");
    ...
    protected MovieSceneScriptingObjectPathKey(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetValue(UnrealSharp.CoreUObject.Object inNewValue)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[SetValue_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            ObjectMarshaller<UnrealSharp.CoreUObject.Object>.ToNative(IntPtr.Add(ParamsBuffer, SetValue_InNewValue_Offset), 0, null, inNewValue);
    ...
    public UnrealSharp.CoreUObject.Object GetValue()
    {
        unsafe
        {
            ...
            returnValue = ObjectMarshaller<UnrealSharp.CoreUObject.Object>.FromNative(IntPtr.Add(ParamsBuffer, GetValue_ReturnValue_Offset), 0, null);

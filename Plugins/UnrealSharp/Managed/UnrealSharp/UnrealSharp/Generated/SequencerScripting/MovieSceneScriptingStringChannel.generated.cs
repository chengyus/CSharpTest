...
[UClass]
public partial class MovieSceneScriptingStringChannel : UnrealSharp.SequencerScripting.MovieSceneScriptingChannel
{
    
    static MovieSceneScriptingStringChannel()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingStringChannel");
    ...
    protected MovieSceneScriptingStringChannel(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetDefault(string inDefaultValue)
    {
        unsafe
        {
            ...
            IntPtr InDefaultValue_NativePtr = IntPtr.Add(ParamsBuffer,SetDefault_InDefaultValue_Offset);
    ...
    public string GetDefault()
    {
        unsafe
        {
            ...
            string returnValue;
            IntPtr ReturnValue_NativePtr = IntPtr.Add(ParamsBuffer,GetDefault_ReturnValue_Offset);
    ...
    public UnrealSharp.SequencerScripting.MovieSceneScriptingStringKey AddKey(UnrealSharp.CoreUObject.FrameNumber inTime, string newValue, float subFrame = 0.000000f, UnrealSharp.SequencerScripting.ESequenceTimeUnit timeUnit = UnrealSharp.SequencerScripting.ESequenceTimeUnit.DisplayRate)
    {
        unsafe
        {
            ...
            IntPtr NewValue_NativePtr = IntPtr.Add(ParamsBuffer,AddKey_NewValue_Offset);
            StringMarshaller.ToNative(NewValue_NativePtr,0,null,newValue);
            ...
            UnrealSharp.SequencerScripting.MovieSceneScriptingStringKey returnValue;
            returnValue = ObjectMarshaller<UnrealSharp.SequencerScripting.MovieSceneScriptingStringKey>.FromNative(IntPtr.Add(ParamsBuffer, AddKey_ReturnValue_Offset), 0, null);
            
            StringMarshaller.DestructInstance(NewValue_NativePtr, 0);
            return returnValue;
        }
    }

...
[UClass]
public partial class MovieSceneScriptingStringKey : UnrealSharp.SequencerScripting.MovieSceneScriptingKey
{
    
    static MovieSceneScriptingStringKey()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("MovieSceneScriptingStringKey");
    ...
    protected MovieSceneScriptingStringKey(IntPtr nativeObject) : base(nativeObject)
    {
    }
    ...
    public void SetValue(string inNewValue)
    {
        unsafe
        {
            ...
            IntPtr InNewValue_NativePtr = IntPtr.Add(ParamsBuffer,SetValue_InNewValue_Offset);
            StringMarshaller.ToNative(InNewValue_NativePtr,0,null,inNewValue);
            
            UObjectExporter.CallInvokeNativeFunction(NativeObject, SetValue_NativeFunction, ParamsBuffer);
            
            StringMarshaller.DestructInstance(InNewValue_NativePtr, 0);
        }
    }
    ...
    public string GetValue()
    {
        unsafe
        {
            ...
            string returnValue;
            IntPtr ReturnValue_NativePtr = IntPtr.Add(ParamsBuffer,GetValue_ReturnValue_Offset);

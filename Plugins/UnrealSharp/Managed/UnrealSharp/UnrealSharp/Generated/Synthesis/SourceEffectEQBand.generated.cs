...
[UStruct]
public partial struct SourceEffectEQBand
{
    // FloatProperty /Script/Synthesis.SourceEffectEQBand:Frequency
    static readonly int Frequency_Offset;
    public float Frequency;
    
    // FloatProperty /Script/Synthesis.SourceEffectEQBand:Bandwidth
    static readonly int Bandwidth_Offset;
    public float Bandwidth;
    
    // FloatProperty /Script/Synthesis.SourceEffectEQBand:GainDb
    static readonly int GainDb_Offset;
    public float GainDb;
    
    // BoolProperty /Script/Synthesis.SourceEffectEQBand:bEnabled
    ...
    static SourceEffectEQBand()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeStructFromName("SourceEffectEQBand");
    ...
    public SourceEffectEQBand(IntPtr InNativeStruct)
    {
        unsafe
        {
...
public static class SourceEffectEQBandMarshaler
{
    public static SourceEffectEQBand FromNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner)
    {
        return new SourceEffectEQBand(nativeBuffer + arrayIndex * GetNativeDataSize());
    }
    
    public static void ToNative(IntPtr nativeBuffer, int arrayIndex, UnrealSharpObject owner, SourceEffectEQBand obj)
    {
    ...
    {
        return SourceEffectEQBand.NativeDataSize;
    }
}
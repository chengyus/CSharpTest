...
[UClass]
public partial class SourceEffectStereoDelayPreset : UnrealSharp.Engine.SoundEffectSourcePreset
{
    
    static SourceEffectStereoDelayPreset()
    {
        IntPtr NativeClassPtr = UCoreUObjectExporter.CallGetNativeClassFromName("SourceEffectStereoDelayPreset");
    ...
    protected SourceEffectStereoDelayPreset(IntPtr nativeObject) : base(nativeObject)
    {
    }
    // StructProperty /Script/Synthesis.SourceEffectStereoDelayPreset:Settings
    static readonly int Settings_Offset;
    
    public UnrealSharp.Synthesis.SourceEffectStereoDelaySettings Settings
    {
        get
        {
            CheckObjectForValidity();
            return UnrealSharp.Synthesis.SourceEffectStereoDelaySettingsMarshaler.FromNative(IntPtr.Add(NativeObject, Settings_Offset), 0, this);
        }
    }
    ...
    public void SetSettings(UnrealSharp.Synthesis.SourceEffectStereoDelaySettings inSettings)
    {
        unsafe
        {
            byte* ParamsBufferAllocation = stackalloc byte[SetSettings_ParamsSize];
            nint ParamsBuffer = (IntPtr) ParamsBufferAllocation;
            UnrealSharp.Synthesis.SourceEffectStereoDelaySettingsMarshaler.ToNative(IntPtr.Add(ParamsBuffer, SetSettings_InSettings_Offset), 0, null, inSettings);
